            ...
            <v-navigation-drawer app clipped flat v-model="sideBar">
                <v-list>
                    ...
                    <v-list-item
                        class="px-2"
                        key="deliveryOrders"
                        to="/foodDeliveries/deliveryOrders"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
                    ...
                    <v-list-item
                        class="px-2"
                        key="restaurantManagements"
                        to="/restaurantManagements/restaurantManagements"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
...
export default {
    ...
    data: () => ({
        ...
        aggregate: [
            { 
                title: '음식 주문', 
                description: '음식 주문과 관련된 정보를 관리합니다.', 
                key: 'foodOrders', 
                route: '/foodOrderings/foodOrders',
                ImageUrl: '',
            },
            { 
                title: '음식점', 
                description: '음식점 정보를 관리합니다.', 
                key: 'restaurants', 
                route: '/foodOrderings/restaurants',
                ImageUrl: '',
            },
            { 
                title: '배달 주문', 
                description: '배달 주문과 관련된 정보를 관리합니다.', 
                key: 'deliveryOrders', 
                route: '/foodDeliveries/deliveryOrders',
                ImageUrl: '',
            },
            { 
                title: '음식 가게 관리', 
                description: '음식 가게 정보를 관리합니다.', 
                key: 'restaurantManagements', 
                route: '/restaurantManagements/restaurantManagements',
                ImageUrl: '',
            },
