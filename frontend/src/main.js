...
pluralCaseList.push( {plural: "foodOrderings/foodOrders", pascal: "FoodOrderingFoodOrder"} )
pluralCaseList.push( {plural: "foodOrderings/restaurants", pascal: "FoodOrderingRestaurant"} )

pluralCaseList.push( {plural: "foodDeliveries/deliveryOrders", pascal: "FoodDeliveryDeliveryOrder"} )

pluralCaseList.push( {plural: "restaurantManagements/restaurantManagements", pascal: "RestaurantManagementRestaurantManagement"} )
